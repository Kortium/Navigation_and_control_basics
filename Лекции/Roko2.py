...
class Roko2:
    ...
    def update(self):
        ...
        self._Velocity_set.append(self._velocity_set)
        self._Angular_rate_set.append(self._angular_rate_set)
        if len(self._Time) == 0:
    ...
    def __init__(self, x, y, heading, velocity, angular_rate):
        ...
        self._Angular_rate = []
        self._Velocity_set = []
        self._Angular_rate_set = []
        self._Time = []


    # Законы управления двигателями
    def set_motion(self, velocity, angular_rate):
        ...
        With errors!!!'''
        self._velocity_set = velocity
        self._angular_rate_set = angular_rate
    ...
    def plot_results(self):
        ...
        ax4.plot(self._Time, self._Angular_rate_set, 'r', linewidth=2)
        ax4.grid()
        ax4.set_ylabel('Angular rate, rad/s')
        # Plot Velocity graph
        ax5.plot(self._Time, self._Velocity, 'm', linewidth=2)
        ax5.plot(self._Time, self._Velocity_set, 'k', linewidth=2)
        ax5.grid()
